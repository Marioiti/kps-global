...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'city.sanya': 'Sanya',
    'city.denpasar': 'Denpasar',
    'city.moscow': 'Moscow',
    'city.chicago': 'Chicago',
    'city.dubai': 'Dubai',
    'geo.singapore': 'Singapore',
    'geo.china': 'China',
    'geo.hongkong': 'Hong Kong',
  ...
  ru: {
    ...
    'city.sanya': 'Санья',
    'city.denpasar': 'Денпасар',
    'city.moscow': 'Москва',
    'city.chicago': 'Чикаго',
    'city.dubai': 'Дубай',
    'geo.singapore': 'Сингапур',
    'geo.china': 'Китай',
    'geo.hongkong': 'Гонконг',
    'geo.malaysia': 'Малайзия',
    'geo.usa': 'США',
    'geo.uae': 'ОАЭ',
    'geo.india': 'Индия',
    'geo.indonesia': 'Индонезия',
    'geo.russia': 'Россия',
